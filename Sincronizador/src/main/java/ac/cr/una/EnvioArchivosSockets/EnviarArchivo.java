...
class EnviarArchivo {
    ...
    private String ipMaquinaDestino = "";
         
    public EnviarArchivo( String nombreArchivo, String ipMaquinaDestino ) {
        this.nombreArchivo = nombreArchivo;
        this.ipMaquinaDestino = ipMaquinaDestino;
    }
    ...
    public void enviarArchivo() {
        ...
        try {
            ...
            InetAddress direccion = InetAddress.getByName( ipMaquinaDestino );
         
            // Creamos el Socket con la direccion y elpuerto de comunicacion
            Socket socket = new Socket( direccion, 8889 );
    ...
    public static void main( String args[] ) {
        EnviarArchivo ea = new EnviarArchivo( "C:\\SistemasDistribuidos\\Pruebas.txt", "192.168.1.7" );
        ea.enviarArchivo();
    }         
}